    ...
    $stateProvider
        ...
        .state('home.error-500', {//500
            ...
            controller: function($stateParams) {
                return swal($stateParams.name)
            }
        })
        .state('home.Bootstrap', {//ui-Bootstrap
            url: '/Bootstrap',
            templateUrl: 'templates/angular-ui/Bootstrap.html'
        })
        .state('home.sortable', {//ui-sortable
            url: '/sortable',
            templateUrl: 'templates/angular-ui/sortable.html'
        })
