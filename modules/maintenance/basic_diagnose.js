routerApp.controller('basicDiagnoseCtrl',function(toaster,$scope,$http,$q,i18nService){
	var _this = this;
	//列定义
	$scope.columns = [
        {
    ...
    var intFields = ['type','flag','diagnose','opTimes','ipTimes'];
	//查询框
	$scope.filter = {
		pageIndex: 1,
		pageSize: 10,
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicDiagnose/getList';
	$scope.updateUrl = 'management/maintenance/basicDiagnose/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicDiagnose/delete';
	$scope.regions = [];
