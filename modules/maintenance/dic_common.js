routerApp.controller('dicCommonCtrl',function(toaster,$scope,$http,$q,i18nService){
	var _this = this;
	//列定义
	$scope.columns = [
        {
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/dicCommon/getList';
	$scope.updateUrl = 'management/maintenance/dicCommon/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/dicCommon/delete';
	$scope.regions = [];
