routerApp.controller('dicPublicHealthCtrl',function(toaster,$scope,$http,$q,i18nService){
    ...
    var intFields = ['type','flag','parentId','hierarchy' ];
	//查询框
	$scope.filter = {
		pageIndex: 1,
		pageSize: 10,
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/dicPublicHealth/getList';
	$scope.updateUrl = 'management/maintenance/dicPublicHealth/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/dicPublicHealth/delete';
	$scope.regions = [];
