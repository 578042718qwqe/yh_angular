routerApp.controller('baseDeptCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.columns = [
        ...
        {name: '科室类别',field:'type'},
        {name: '机构分类',field:'category'},
//        {name: '状态',field:'flag',cellTemplate:'<span class="data_maintenance_state">{{grid.appScope.getFlagText(row.entity)}}</span>'},
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicDept/getList';
	$scope.updateUrl = 'management/maintenance/basicDept/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicDept/delete';
	$scope.regions = [];
