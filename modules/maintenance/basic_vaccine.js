routerApp.controller('basicVaccineCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicVaccine/getList';
	$scope.updateUrl = 'management/maintenance/basicVaccine/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicVaccine/delete';
	$scope.regions = [];
