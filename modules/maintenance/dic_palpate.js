routerApp.controller('dicPalpateCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.columns = [
        ...
        {name: '部位类型',field:'type'},
        {name: '分组',field:'pGroup'},
        {name: '方法',field:'method'},
        {name: '类别编码',field:'typeCode'},
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/dicPalpate/getList';
	$scope.updateUrl = 'management/maintenance/dicPalpate/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/dicPalpate/delete';
	$scope.regions = [];
