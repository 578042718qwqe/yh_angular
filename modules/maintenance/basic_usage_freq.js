routerApp.controller('basicUsageFreqCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.columns = [
        ...
        {name: '拉丁文缩写',field:'latinAb'},
        {name: '次数',field:'number'},
        {name: '间隔',field:'intervalNum'},
        {name: '间隔单位',field:'intervalUnit'},
        {name: '类型',field:'type'},
    ...
    var intFields = ['type','flag','number','intervalNum','intervalUnit'];
	//查询框
	$scope.filter = {
		pageIndex: 1,
		pageSize: 10,
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicUsageFreq/getList';
	$scope.updateUrl = 'management/maintenance/basicUsageFreq/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicUsageFreq/delete';
	$scope.regions = [];
