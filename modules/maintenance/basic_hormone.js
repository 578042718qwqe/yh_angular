routerApp.controller('basicHormoneCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.columns = [
        ...
        {name: '16位编码',field:'code'},
        {name: '名称',field:'name'},
        {name: '起始使用时间',field:'startTime',cellTemplate: '<span class="data_maintenance_state">{{grid.appScope.getTimeText(row.entity)}}</span>'},
        {name: '结束时间',field:'endTime',cellTemplate: '<span class="data_maintenance_state">{{grid.appScope.getTimeText(row.entity)}}</span>'},
        {name: '类型',field:'type'},
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicHormone/getList';
	$scope.updateUrl = 'management/maintenance/basicHormone/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicHormone/delete';
	$scope.regions = [];
