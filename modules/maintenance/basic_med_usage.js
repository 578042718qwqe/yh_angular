routerApp.controller('basicMedUsageCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicMedUsage/getList';
	$scope.updateUrl = 'management/maintenance/basicMedUsage/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicMedUsage/delete';
	$scope.regions = [];
