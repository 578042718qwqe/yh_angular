routerApp.controller('basicInsTypeCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.columns = [
        ...
        {name: '地区ID',field:'regionId'},
        {name: '医院Id',field:'hospId'},
        {name: '类型编码',field:'code'},
        {name: '名称',field:'name'},
        {name: '类型',field:'type'},
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicInsType/getList';
	$scope.updateUrl = 'management/maintenance/basicInsType/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicInsType/delete';
	$scope.regions = [];
