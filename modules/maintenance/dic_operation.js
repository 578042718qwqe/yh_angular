routerApp.controller('dicOperationCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/dicOperation/getList';
	$scope.updateUrl = 'management/maintenance/dicOperation/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/dicOperation/delete';
	$scope.regions = [];
