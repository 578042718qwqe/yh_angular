routerApp.controller('basicFormUsageCtrl',function(toaster,$scope,$http,$q,i18nService){
	...
	$scope.columns = [
        ...
        {name: '编码',field:'code'},
        {name: '用法编号',field:'usageCode'},
        {name: '默认用法',field:'defUsage'},
	...
	$scope.model = {};
	$scope.getListUrl = 'management/maintenance/basicFormUsage/getList';
	$scope.updateUrl = 'management/maintenance/basicFormUsage/addOrUpdate';
	$scope.removeUrl = 'management/maintenance/basicFormUsage/delete';
	$scope.regions = [];
